...
class Level:
	...
	def save(self):
		...
		for ent in self.entities:
			ent_data += ent.save()
		groups_data = b"kS38,"
		for cc in self.color_channels:
			groups_data += cc.save() + b"|"
		groups_data += b",kA13,0,kA15,0,kA16,0,kA14,,kA6,0,kA7,0,kA17,0,kA18,0,kS39,0,kA2,0,kA3,0,kA8,0,kA4,0,kA9,0,kA10,0,kA11,0;"
		# Standard color channels data
